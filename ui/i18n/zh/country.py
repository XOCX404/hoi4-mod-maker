...
STRINGS: dict[str, str] = {
    ...
    "country_create_btn": "创建国家",
    "country_hint": "选中国家后，点击State可分配领土快速创建: 创建后自动进入领土分配模式",
    ...
    "country_quick_create_btn": "快速创建国家",
    "country_quick_create_tip": "输入 TAG/名称/执政党，一键创建并进入领土分配模式",
